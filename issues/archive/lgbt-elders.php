...
<meta name="description" content="NSRAP's elders project" />
...
<meta property="og:description" content="NSRAP's elders project" />
<meta property="og:url" content="https://nsrap.ca/issues/archive/lgbt-elders.php" />
...
<body>
    ...
    <div class="maincontainer" id="main" role="main">
      ...
      <div class="textbox ninewide" tabindex="0" aria-label="main text">
         <div class="padded">
            <h1>LGBT+ Elders Project</h1>
         <?php
            
            $text = fopen("../../text/elders-project.txt", "r") or die("The specified text could not be found.");
              while (!feof($text)) {
                echo fgets($text) . "<br>";
                }
              fclose($text);
      ...
      <div class="linkcase ninewide" role="navigation" aria-label="sub-navigation">
         <a href="../../community/elderberries.php" class="navlink greenb incol solo"><div class="padded">Elderberries</div></a>
      </div>
