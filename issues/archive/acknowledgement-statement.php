...
<meta name="description" content="Acknowledgement Statement 2017" />
...
<meta property="og:description" content="Acknowledgement Statement 2017" />
...
<body>
    ...
    <div class="maincontainer" id="main" role="main">
      ...
      <div class="textbox ninewide" tabindex="0" aria-label="main text">
         <div class="padded">
            <h1>Acknowledgement Statement 2017</h1>
         <?php
            
            $text = fopen("../../text/acknowledgement-2017.txt", "r") or die("The specified text could not be found.");
              while (!feof($text)) {
                echo fgets($text) . "<br>";
                }
              fclose($text);
