...
<meta name="description" content="Halifax Pride timeOUT Lecture Series" />
...
<meta property="og:description" content="Halifax Pride timeOUT Lecture Series" />
<meta property="og:url" content="https://nsrap.ca/issues/archive/timeout-lectures.php" />
...
<body>
    ...
    <div class="maincontainer" id="main" role="main">
      ...
      <div class="textbox ninewide" tabindex="0" aria-label="main text">
         <div class="padded">
            <h1>Halifax Pride timeOUT Lecture Series</h1>
         <?php
            
            $text = fopen("../../text/timeout.txt", "r") or die("The specified text could not be found.");
              while (!feof($text)) {
                echo fgets($text) . "<br>";
                }
              fclose($text);
