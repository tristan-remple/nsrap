...
<meta name="description" content="NSRAP's previous mission statement" />
...
<meta property="og:description" content="NSRAP's previous mission statement." />
<meta property="og:url" content="https://nsrap.ca/issues/archive/prev-mission-statement.php" />
...
<body>
    ...
    <div class="maincontainer" id="main" role="main">
      ...
      <div class="textbox ninewide" tabindex="0" aria-label="main text">
         <div class="padded">
            <h1>Previous Mission Statement</h1>
         <?php
            
            $text = fopen("../../text/prev-mission.txt", "r") or die("The specified text could not be found.");
              while (!feof($text)) {
                echo fgets($text) . "<br>";
                }
              fclose($text);
