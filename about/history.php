...
<title>NSRAP History</title>
<meta name="title" content="NSRAP History" />
<meta name="description" content="Learn about the history that preceded the Nova Scotia Rainbow Action Project." />
<meta name="robots" content="index, follow" />
<meta name="web-author" content="Tristan Remple" />

<meta property="og:site_name" content="NSRAP" />
<meta property="og:title" content="NSRAP History" />
<meta property="og:description" content="Learn about the history that preceded the Nova Scotia Rainbow Action Project." />
<meta property="og:url" content="https://nsrap.ca/about/history.php" />
...
<body>
    ...
    <div class="maincontainer" id="main" role="main">
      ...
      <div class="textbox fullwidth" tabindex="0" aria-label="main text">
         <div class="padded">
            <h1>History of Nova Scotia 2SLGBTQIA+ Activism</h1>
         <?php
            
            $text = fopen("../text/history.txt", "r") or die("The specified text could not be found.");
              while (!feof($text)) {
                echo fgets($text) . "<br>";
                }
              fclose($text);
         ...
         <div class="onethird">
            <div class="sideimgbox fullwidth">
               <img class="sideimg fullwidth" src="../images/truro-pride-2016.jpg">
            </div>
         </div>
      </div>
